  ...
  return (
    <div className="slide">
      ...
      <div className="platform-cards">
        <div className="card platform-card">
          ...
          <p className="platform-url">
            <a href="https://prokom.sentry.io/issues/?environment=development&project=4511564169478224&statsPeriod=1h" target="_blank" rel="noopener noreferrer">
              sentry.io
            </a>
          </p>
        ...
        <div className="card platform-card">
          ...
          <h3>GlitchTip</h3>
          <p className="platform-url">
            <a href="https://glitchtip.backstage.prokom.no/prokom/issues?project=2" target="_blank" rel="noopener noreferrer">
              glitchtip.backstage.prokom.no
            </a>
          </p>
      ...
      <p className="platform-note">
        Begge bruker <code>@sentry/react</code> — eneste forskjell er DSN.
        <br />
